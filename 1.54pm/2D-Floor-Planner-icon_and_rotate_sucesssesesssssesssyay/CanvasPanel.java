...
public class CanvasPanel extends JPanel {
    ...
    private final JPopupMenu rotateFurniturePopup;
    ...
    public CanvasPanel() {
        ...
        //Furniture POpup menus
        rotateFurniturePopup = new JPopupMenu();
        JMenuItem rotateFurnitureMenuItem = new JMenuItem("Rotate");
        JMenuItem deleteFurnitureMenuItem = new JMenuItem("Delete");

        // Add action listeners for menu items
        rotateFurnitureMenuItem.addActionListener(e -> rotateFurniture());
        deleteFurnitureMenuItem.addActionListener(e -> deleteFurniture());
    ...
    public void rotateFurniture() {
        if (itemToAdd != null) {
            itemToAdd.rotateFurniture();
        }
    }

    private void deleteFurniture() {
        if (selectedFurniture != null) {
            // Remove the selected furniture from the list
            furnitureList.remove(selectedFurniture);
            selectedFurniture = null; // Reset the selection
