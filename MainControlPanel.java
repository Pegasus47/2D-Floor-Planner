...
public class MainControlPanel extends JPanel {
    ...
    public String selectedItem = "Bed";
    ...
    public void showObjectsGrid() {
        ...
        bed.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Bed"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        bookshelf.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Bookshelf"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        closet.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Closet"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });

        diningTable.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Dining Table"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
        ...
        fridge.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Fridge"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });

        kitchenTable.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Kitchen Table"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        desk.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Desk"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        sofa.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Sofa"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        table.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Table"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        chair.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Chair"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });

        toilet.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Toilet"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
        ...
        sink.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                selectedItem = "Sink"; // Set the selected item to "Bed"
                canvasPanel.setSelectedItem(selectedItem);
                canvasPanel.setItemPlacement(true);
            }
        });
