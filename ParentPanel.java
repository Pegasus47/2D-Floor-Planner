...
public class ParentPanel extends JPanel {
    public ParentPanel() {
        setBackground(new Color(30, 30, 30)); // Background of parent panel
        setPreferredSize(new Dimension(400, 700)); // Fixed parent panel size
        ...
        leftControlWrapper.setBackground(new Color(30, 30, 30)); // Match parent background
        leftControlWrapper.setLayout(new BoxLayout(leftControlWrapper, BoxLayout.Y_AXIS));
        leftControlWrapper.setBorder(new EmptyBorder(10, 10, 10, 10));
        ...
        mainControlWrapper.setBackground(new Color(30, 30, 30)); // Match parent background
        mainControlWrapper.setLayout(new BoxLayout(mainControlWrapper, BoxLayout.Y_AXIS));
        mainControlWrapper.setBorder(new EmptyBorder(10, 10, 10, 10));
